...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: D3stroyer King (@d3stroyer_xd)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "D3stroyer_MusicBot"
    usar = user
    wew = usar.id
    try:
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"**🎸 Ƥɭɘɑsɘ ❤️ Ɱɑŋʋɑɭɭy 🥀 Ʌɗɗ 💫 Ʌssɩsʈɑŋʈ @D3stroyer_Assistant 😔 Øɤ 🎸 Ƈøŋʈɑƈʈ ❤️ ʈø : @D3stroyer_xd 🥀** ")
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/a675f2e6e289569f79cfe.jpg"
            ...
            [
                [
                        InlineKeyboardButton(
                            ...
                            url=f"https://t.me/d3stroyer_Support")
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/a675f2e6e289569f79cfe.jpg", 
                             caption="**💥  🔈 Mʋsɩƈ🤞Nøω 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
